...
materials, source/tally definitions, closed-form cost model, the complete
256-configuration enumeration results with the resulting 25-point true
Pareto frontier, and a surrogate-screened Adaptive Randomized Rounding
search verified directly against that ground truth (68/256 real
evaluations, exact optimum at 13/25 budget levels, all others within 6%).
...
i4-fusion-blanket-verification/
  ...
  code/
    ...
    surrogate_search.py           <- surrogate-screened ARR search, checked against ground truth
  results/
...
the small instance; surrogate-screened search verified directly against
that ground truth. Geometry is currently a simplified solid (non-hollow)
